...
<!--BW6 START ATTEMPT TO DO NEWS AND UDPATES A DIFFERENT WAY -->
					...
					<?php
						...
						if ($lc=="en") print "<div class='field-label'>News and Updates:</div>";
					    if ($lc=="es") print "<div class='field-label'>Notas de prensa y boletines mensuales:</div>";

						if ($lc=="en") print "<A HREF='/byproject/$node->nid'>for $title</A><BR/>";
					    if ($lc=="es") print "<A HREF='/es/byproject/$node->nid'>por $title</A><BR/>";

						foreach ($terms as $term){
							if ($lc=="en") print "<A HREF='/newsupdate/$term->tid'>for $term->name</A><BR/>"; 
							if ($lc=="es") print "<A HREF='/es/newsupdate/$term->tid'>por $term->name</A><BR/>";  
						 }
